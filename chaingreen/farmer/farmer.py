...
from chaingreen.pools.pool_config import PoolWalletConfig, load_pool_config
from chaingreen.protocols import farmer_protocol, harvester_protocol
from chaingreen.protocols.pool_protocol import (
    ErrorResponse,
...
from chaingreen.util.config import load_config, save_config, config_path_for_filename
...
from chaingreen.wallet.puzzles.singleton_top_layer import SINGLETON_MOD
...
class Farmer:
    ...
    def set_reward_targets(self, farmer_target_encoded: Optional[str], pool_target_encoded: Optional[str]):
        ...
        if farmer_target_encoded is not None:
            ...
            config["farmer"]["cgn_target_address"] = farmer_target_encoded
        if pool_target_encoded is not None:
            self.pool_target_encoded = pool_target_encoded
            self.pool_target = decode_puzzle_hash(pool_target_encoded)
            config["pool"]["cgn_target_address"] = pool_target_encoded
