...
from chaingreen.util.condition_tools import conditions_dict_for_solution
from chaingreen.util.ints import uint64
from chaingreen.wallet.puzzles.cc_loader import CC_MOD, LOCK_INNER_PUZZLE
from chaingreen.wallet.puzzles.genesis_by_coin_id_with_0 import (
