...
def init_cmd(ctx: click.Context, create_certs: str, fix_ssl_permissions: bool, **kwargs):
    ...
    - Get more details on remote harvester on Chaingreen wiki:
      https://github.com/Chaingreen-Network/chaingreen-blockchain/wiki/Farming-on-many-machines
    """
    from pathlib import Path
    from .init_funcs import init
    from chaingreen.cmds.passphrase_funcs import initialize_passphrase
