...
from chaingreen.full_node.generator import create_generator_args, setup_generator_args
from chaingreen.types.blockchain_format.coin import Coin
from chaingreen.types.blockchain_format.program import NIL
...
from chaingreen.util.clvm import int_from_bytes, int_to_bytes
...
from chaingreen.util.ints import uint32, uint64, uint16
from chaingreen.wallet.puzzles.generator_loader import GENERATOR_FOR_SINGLE_COIN_MOD
from chaingreen.wallet.puzzles.rom_bootstrap_generator import get_generator
...
def parse_aggsig(args: SExp) -> List[bytes]:
    ...
    # just like as_atom_list() (see chaingreen/types/blockchain_format/program.py)
