...
import stat
import sys
from chaingreen.util.config import load_config, traverse_dict
from chaingreen.util.permissions import octal_mode_string, verify_file_permissions
...
def check_ssl(root_path: Path) -> None:
    ...
    if not valid:
        ...
        print("Run `chaingreen init --fix-ssl-permissions` to fix issues.")
