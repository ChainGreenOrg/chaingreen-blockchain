...
{
    Write-Output "Chaingreen requires a 64-bit Windows installation"
    Exit 1
}
...
Write-Output ""
Write-Output "Chaingreen blockchain .\Install.ps1 complete."
...
Write-Output ""
Write-Output "Try the Quick Start Guide to running chaingreen-blockchain:"
Write-Output "https://github.com/Chaingreen-Network/chia-blockchain/wiki/Quick-Start-Guide"
Write-Output ""
Write-Output "To install the GUI type '.\Install-gui.ps1' after '.\venv\scripts\Activate.ps1'."
Write-Output ""
Write-Output "Type '.\venv\Scripts\Activate.ps1' and then 'chaingreen init' to begin."
