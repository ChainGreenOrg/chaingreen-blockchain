...
wallet_program_files = set(
    [
        ...
        "chaingreen/wallet/puzzles/rom_bootstrap_generator.clvm",
        "chaingreen/wallet/puzzles/generator_for_single_coin.clvm",
        "chaingreen/wallet/puzzles/genesis-by-coin-id-with-0.clvm",
        "chaingreen/wallet/puzzles/genesis-by-puzzle-hash-with-0.clvm",
        "chaingreen/wallet/puzzles/lock.inner.puzzle.clvm",
        "chaingreen/wallet/puzzles/p2_conditions.clvm",
        "chaingreen/wallet/puzzles/p2_delegated_conditions.clvm",
        "chaingreen/wallet/puzzles/p2_delegated_puzzle.clvm",
        "chaingreen/wallet/puzzles/p2_delegated_puzzle_or_hidden_puzzle.clvm",
        "chaingreen/wallet/puzzles/p2_m_of_n_delegate_direct.clvm",
        "chaingreen/wallet/puzzles/p2_puzzle_hash.clvm",
        "chaingreen/wallet/puzzles/rl_aggregation.clvm",
        "chaingreen/wallet/puzzles/rl.clvm",
        "chaingreen/wallet/puzzles/sha256tree_module.clvm",
        "chaingreen/wallet/puzzles/singleton_top_layer.clvm",
        "chaingreen/wallet/puzzles/did_innerpuz.clvm",
        "chaingreen/wallet/puzzles/decompress_puzzle.clvm",
        "chaingreen/wallet/puzzles/decompress_coin_solution_entry_with_prefix.clvm",
        "chaingreen/wallet/puzzles/decompress_coin_solution_entry.clvm",
...
clvm_include_files = set(
    ["chaingreen/wallet/puzzles/create-lock-puzzlehash.clvm", "chaingreen/wallet/puzzles/condition_codes.clvm"]
)

CLVM_PROGRAM_ROOT = "chaingreen/wallet/puzzles"
