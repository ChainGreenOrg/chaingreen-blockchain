...
from chaingreen.pools.pool_config import PoolWalletConfig
from chaingreen.util.config import load_config, save_config, create_default_chaingreen_config
...
def test_pool_config():
    ...
    create_default_chaingreen_config(test_root, ["config.yaml"])
