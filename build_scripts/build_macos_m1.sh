...
if [ "$NOTARIZE" ]; then
  electron-osx-sign Chaingreen-darwin-arm64/Chaingreen.app --platform=darwin \
...
electron-installer-dmg dist/Chaingreen-darwin-arm64/Chaingreen.app Chaingreen-$CHAINGREEN_INSTALLER_VERSION-arm64 \
