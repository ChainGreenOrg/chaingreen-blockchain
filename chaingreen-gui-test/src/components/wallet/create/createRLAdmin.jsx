...
export const CreateRLAdminWallet = () => {
  ...
  function create() {
    ...
    if (
      chaingreenper_input.value === '' ||
      Number(chaingreenper_input.value) === 0 ||
      !Number(chaingreenper_input.value) ||
      isNaN(Number(chaingreenper_input.value))
    ) {
      dispatch(
        openDialog(
          <AlertDialog>
    ...
    const chaingreenper = chaingreen_to_mio(chaingreenper_input.value);
    const chaingreenper_value = Number.parseInt(Number(chaingreenper));
    ...
    // var fee = chaingreen_to_mio(fee_input.value);
