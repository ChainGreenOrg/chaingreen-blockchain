...
const IncompleteCard = (props) => {
  ...
  function submit() {
    ...
    const chaingreenper_input = ip_parsed.limit;
    ...
    const chaingreenper_value = Number.parseInt(Number(chaingreenper_input));
        ...
        <Grid item xs={12}>
          <Box display="flex">
            ...
            <Box flexGrow={1}>
              <Typography variant="subtitle1">
                <Trans>
                  Spending Limit (chaingreen per interval):{' '}
                  {mio_to_chaingreen_string(limit)}
                </Trans>
              </Typography>
            </Box>
          </Box>
